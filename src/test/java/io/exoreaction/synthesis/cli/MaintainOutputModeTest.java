...
class MaintainOutputModeTest {
    ...
    void quiet_line_contains_phases_count() throws Exception {
        ...
        String line = output.lines()
                ...
                .findFirst()
                .orElse("");
        assertTrue(line.contains("12 phases"),
                "quiet line should contain '12 phases': " + line);
    }
    ...
    void json_has_all_9_phases() throws Exception {
        ...
        assertEquals(12, root.get("phases").size(),
                "phases array must have exactly 12 elements");
    }
